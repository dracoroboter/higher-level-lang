...
```
benchmarkapp/           Java reference app (OrderSystem: server+client+DB+cache+queue)
...
│   └── benchmarkapp/   HLL translation of the reference app
├── p5a/                "iterate classic" — for-in + lambda pipeline
