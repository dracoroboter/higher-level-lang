...
// for-in with declarative clauses (SQL-style)
forInStmt
    : 'for' IDENT 'in' expr whenClause* takeClause? block
    ;
...
primary
    ...
    | 'for' IDENT 'in' expr whenClause* takeClause? yieldClause  # forYieldExpr
    | 'for' IDENT 'in' expr whenClause* takeClause? intoClause   # forIntoExpr
    | IDENT                                     # identifier
    | STRING                                    # stringLit
    | NUMBER                                    # numberLit
    | FLOAT                                     # floatLit
